                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <asp:Label CssClass="form-control">Employee Number</asp:Label>
                                    <asp:TextBox ID="emp_num" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                                <div>
                                    <asp:DropDownList CssClass="form-control" ID="timesheetPeriod" OnSelectedIndexChanged="choosePeriod" runat="server">
                                        <asp:ListItem CssClass="form-control" Text="Current" Selected="True" Value="1"></asp:ListItem>
                                        <asp:ListItem CssClass="form-control" Text="Previous" Value="2"></asp:ListItem>
                                        <asp:ListItem CssClass="form-control" Text="Next" Value="3"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="row">
